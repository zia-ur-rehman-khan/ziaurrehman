...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of frontend engineer Zia Ur Rehman." },
      { name: "author", content: "Zia Ur Rehman" },
      { property: "og:title", content: "Zia Ur Rehman | Frontend Engineer" },
      { property: "og:description", content: "Frontend engineer building scalable, high-performance web applications." },
